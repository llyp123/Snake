...
Scene* RankingList2::createScene()
{
    return RankingList2::create();
}
...
bool RankingList2::init()
{
    ...
    auto closeItem = MenuItemImage::create(
        "CloseNormal.png",
        "CloseSelected.png",
        CC_CALLBACK_1(RankingList2::menuCloseCallback, this));
    ...
    auto backButton = MenuItemImage::create(
        "begin.png",
        "pbegin.png",
        CC_CALLBACK_1(RankingList2::back, this));
...
void RankingList2::menuCloseCallback(Ref* pSender)
{
...
void RankingList2::back(Ref* pSender)
{
